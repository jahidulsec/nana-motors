        ...
        <Section className="pt-5 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 my-5 border-b pb-5">
            <p>
              ...
              <Input id="name" defaultValue={customerData && customerData?.name} placeholder="Enter customer full name" />
            </p>
            <p>
              <Label htmlFor="fatherName">Father&apos;s Name</Label>
              <Input id="fatherName" defaultValue={customerData && customerData.fatherName || '' } placeholder="Enter father name" />
            </p>
            <p>
              <Label htmlFor="motherName">Mother&apos;s Name</Label>
              <Input id="motherName" defaultValue={customerData && customerData.motherName || '' } placeholder="Enter mother name" />
            </p>
            <p>
              <Label htmlFor="spouseName">Spouse Name</Label>
              <Input id="spouseName" defaultValue={customerData && customerData.spouseName || '' } placeholder="Enter spouse name" />
            </p>
            <p>
              <Label htmlFor="mobile">Mobile</Label>
              <Input type="text" id="mobile" placeholder="ex. 01777 333444" defaultValue={customerData && customerData.mobile || '' } />
            </p>
            <p>
          ...
          <div className="address grid grid-cols-1 md:grid-cols-3 gap-3">
            <p>
              ...
              <Input id="houseName" defaultValue={customerData && customerData.houseName || '' } placeholder="Enter house name or number" />
            </p>
            <p>
              <Label htmlFor="village">Village</Label>
              <Input id="village" defaultValue={customerData && customerData.village || '' } placeholder="Enter village name" />
            </p>
            <p>
              <Label htmlFor="postOffice">Post Office</Label>
              <Input id="postOffice" defaultValue={customerData && customerData.postOffice || '' } placeholder="Enter post office name" />
            </p>
            <p>
              <Label htmlFor="upazilla">Upazilla</Label>
              <Input id="upazilla" defaultValue={customerData && customerData.upazilla || '' } placeholder="Enter upazilla name" />
            </p>
            <p>
              <Label htmlFor="district">District</Label>
              <Input id="district" defaultValue={customerData && customerData.district || '' } placeholder="Enter district" />
            </p>
          </div>
        </Section>
